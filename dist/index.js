...
var AssistantAPI = require('@nomyx/assistant');
var Toolbox = require('./toolbox').Toolbox;
var readline = require('readline');
var isBrowser = function () { return typeof window !== 'undefined'; };
var loadConfig = function () { return configManager.getConfig(); };
var saveConfig = function (config) { return configManager.setConfig(config); };
var toolbox = Toolbox.loadToolbox(__dirname, {
    prompt: 'assistant',
    tools: {},
    schemas: [],
    state: {}
...
}); }).on('line', function (line) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
